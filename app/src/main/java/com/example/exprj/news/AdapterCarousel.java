...
public class AdapterCarousel extends PagerAdapter {
    ...
    // Constructer
    public AdapterCarousel(Context context, List<Banner> banners) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        View itemView = layoutInflater.inflate(R.layout.item_carousel_news, container, false);

        // referencing the image view from the item_vpg_game.xml file
        ImageView imgView = itemView.findViewById(R.id.img_carousel_news);
